...
client.on('guildMemberAdd', function(member) {
  ...
  member.guild.channels.find("name", "général").sendMessage('Bienvenue sur la OKA Media Family '
    + member.toString() + ' ! Va faire un tour dans <#442575953705697280> pour voir les règles du server !' );
